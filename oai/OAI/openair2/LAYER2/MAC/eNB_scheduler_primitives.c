...
//------------------------------------------------------------------------------
{
  ...
  if (UE_id >= 0) {
    ...
    if (ul_cqi_information->channel == 0) { // PUCCH
      ...
      if (ul_cqi_information->ul_cqi && UE_id_HL != -1) {
        RC.HL[UE_id_HL].MAC.CSI.pucch2_snr[CC_idP] = ul_cqi_information->ul_cqi;
        RC.HL[UE_id_HL].MAC.CSI.ul_cqi = ul_cqi_information->ul_cqi;
      }
    } else {    //PUSCH
      ...
      if (sched_ctl->dl_cqi[CC_idP] && UE_id_HL != -1) {
        RC.HL[UE_id_HL].MAC.CSI.dl_cqi = sched_ctl->dl_cqi[CC_idP];
      }
    }
    ...
    if (rel9->timing_advance && UE_id_HL != -1) {
      RC.HL[UE_id_HL].MAC.CSI.timing_advance = rel9->timing_advance;
      RC.HL[UE_id_HL].MAC.CSI.timing_advance_r9 = rel9->timing_advance_r9;
    }
  }
